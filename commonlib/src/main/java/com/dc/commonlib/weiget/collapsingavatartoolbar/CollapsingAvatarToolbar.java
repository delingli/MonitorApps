/*
package com.dc.commonlib.weiget.collapsingavatartoolbar;
...
public class CollapsingAvatarToolbar extends LinearLayout implements AppBarLayout.OnOffsetChangedListener {
    ...
    public CollapsingAvatarToolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public CollapsingAvatarToolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
