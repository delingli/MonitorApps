...
public class VideoPlayer extends FrameLayout implements InterVideoPlayer {
    //    public boolean rounded_corners = false;//全部圆角裁剪
...
//    }
    ...
    private void createIjkMediaPlayer() {
        ...
        ((IjkMediaPlayer) mMediaPlayer).setOption(format, "probesize", 5120);
        ...
        //最大缓冲大小,单位kb
        ((IjkMediaPlayer) mMediaPlayer).setOption(player, "max-buffer-size", 100 * 1024);
        ((IjkMediaPlayer) mMediaPlayer).setOption(player, "min-frames", 100);// 视频的话，设置100帧即开始播放
