...
public class VideoPlayerController extends AbsVideoPlayerController implements View.OnClickListener{
    ...
    public void onPlayStateChanged(int playState) {
        switch (playState) {
            ...
            case ConstantKeys.CurrentState.STATE_PLAYING:
                ...
                mImage.setVisibility(View.GONE);//隐藏默认的背景
    ...
    private OnCenterStareListen onCenterStareListen;
    public void addOnCenterStareListen(OnCenterStareListen onCenterStareListen){
        this.onCenterStareListen=onCenterStareListen;
    }
public interface OnCenterStareListen{
    ...
    public void onClick(View v) {
        if (v == mCenterStart) {
            ...
            if (mVideoPlayer.isIdle()) {
                if(onCenterStareListen!=null){
                    onCenterStareListen.onCenterClick();
                }
                mVideoPlayer.start();
